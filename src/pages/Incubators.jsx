...
const Incubators = () => {
    return (
        <div className="incubators-container">
            ...
            <p>Discover a variety of incubators that support and nurture startups, providing them with the resources, mentorship, and networking opportunities needed to thrive. Explore our selection to find the perfect incubator for your entrepreneurial journey.</p>
            <div className="first-inv-info">
                <div className="incu-logo">
                <a target="_blank" rel="noopener noreferrer" href="https://www.kapita.iq/">
                    <img src={kapita} alt="kapitaLogo" width={'100px'} />
                </a>
                </div>
                <div className="incu-logo">
                <a target="_blank" rel="noopener noreferrer" href="https://www.orangecorners.com/country/baghdad-iraq/">
                    <img src={orangecorners} alt="kapitaLogo" width={'100px'} />
                </a>
                </div>
                <div className="incu-logo">
                <a target="_blank" rel="noopener noreferrer" href="https://the-station.iq/">
                ...
                <div className="incu-logo">
                <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/hub200.tiq/">
                ...
                <div className="incu-logo">
                <a target="_blank" rel="noopener noreferrer" href="https://fiveonelabs.org/">
                    <img src={fiveonelabs} alt="kapitaLogo" width={'100px'} />
                </a>
                </div>
                <div className="incu-logo">
                <a target="_blank" rel="noopener noreferrer" href="https://www.responseinnovationlab.com/iraq-agbusiness-incubator">
                    <img src={Response_Innovation_Lab} alt="kapitaLogo" width={'100px'} />
                </a>
                </div>
            </div>
        </div>
